...
#[derive(Debug)]
pub struct AMLScreeningProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AMLScreeningProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AMLScreening processing");
    
    let mut processor = AMLScreeningProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AMLScreeningProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AMLScreeningProcessor::new(false);
